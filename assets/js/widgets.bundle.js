...
var KTCardsWidget200 = {
	init: function() {
		! function() {
			var e = document.getElementById("kt_card_widget_19_chart_other");
			if (e) {
				var t = {
						size: e.getAttribute("data-kt-size") ? parseInt(e.getAttribute("data-kt-size")) : 70,
						lineWidth: e.getAttribute("data-kt-line") ? parseInt(e.getAttribute("data-kt-line")) : 11,
...
"undefined" != typeof module && (module.exports = KTCardsWidget200), KTUtil.onDOMContentLoaded((function() {
	KTCardsWidget200.init()
}));

var KTCardsWidget2000 = {
	init: function() {
		! function() {
			var e = document.getElementById("kt_card_widget_19_chart_second");
			if (e) {
				var t = {
						size: e.getAttribute("data-kt-size") ? parseInt(e.getAttribute("data-kt-size")) : 70,
						lineWidth: e.getAttribute("data-kt-line") ? parseInt(e.getAttribute("data-kt-line")) : 11,
...
"undefined" != typeof module && (module.exports = KTCardsWidget2000), KTUtil.onDOMContentLoaded((function() {
	KTCardsWidget2000.init()
}));
...
var KTChartsWidget35 = function() {
	...
	return {
		init: function() {
			...
			o(r, "#kt_charts_widge_new", "#kt_charts_widget_35_chart_5", u, p, !1), KTThemeMode.on("kt.thememode.change", (function() {
				e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered && r.self.destroy(), o(e, "#kt_charts_widget_35_tab_1", "#kt_charts_widget_35_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_35_tab_2", "#kt_charts_widget_35_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_35_tab_3", "#kt_charts_widget_35_chart_3", m, c, a.rendered), o(l, "#kt_charts_widget_35_tab_4", "#kt_charts_widget_35_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", u, p, r.rendered)
			}))
		}
	}
