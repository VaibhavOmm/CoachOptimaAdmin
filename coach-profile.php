                ...
                <div class="page-header p-0 p-lg-10">
                    <div class="row p-4 rounded">
                        <div class="col-lg-8 col-8">
                            <h4 class="fw-bold text-white mb-5">Coach Profile</h4>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-row flex-wrap gap-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center"> <span class="text-white  ms-2 fs-6">
                                                ...
                                                840562626262</span> </div>
                                        <div class="d-flex flex-row align-items-center"> <span class="text-white  ms-2 fs-6"> <span class="text-white me-0 fs-4">
                                                    <i class="bi bi-star-fill text-white"></i>
                                                </span> 4.52 (1K+ Ratings)</span> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="kt_app_content_container" class="app-container container-fluid mb-5">
                    ...
                    <div class="row gx-5 gx-xl-10 mb-5">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link client-nav text-color" id="Profile-tab" data-bs-toggle="pill" data-bs-target="#Profile" type="button" role="tab" aria-controls="Profile" aria-selected="false">Profile</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                                ...
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bolder text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0">Coaching Sessions</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="card mt-4">
                                                <div class="bg-white px-4 rounded overflow-hidden p-2">
                                                        ...
                                                        <table class="table table-row-bordered mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">112 hr</h6>
                                                                            <p class="fw-normal text-color-secondary">Total Hours</p>
                                                                        </div>
                                                                    </td>

                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">54 hr</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                                <span class="partially-paid rounded-circle d-block me-2"></span>Scheduled
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">59 hr</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                                <span class="unpaid rounded-circle d-block me-2"></span>Unscheduled
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">6 hr</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                                <span class="no-coach rounded-circle d-block me-2"></span>Complete
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div class="status-bar rounded mb-6 d-flex flex-row overflow-hidden">
                                                        <div class="partially-paid-status-bar" style="width:50%"></div>
                                                        <div class="unpaid-status-ba" style="width:45%"></div>
                                                        <div class="nocoach-status-bar" style="width:5%"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-lg-6 mtx-sm-5 col-12">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                                <!--begin::Title-->
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bolder text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0">Projects Info</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="card mt-4">
                                                <div class="bg-white px-4 rounded overflow-hidden p-2">
                                                        ...
                                                        <table class="table table-row-bordered mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">52</h6>
                                                                            <p class="fw-normal text-color-secondary">Total Projects</p>
                                                                        </div>
                                                                    </td>

                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">18</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">28</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column">
                                                                            <h6 class="fw-bold text-color">6</h6>
                                                                            <h6 class="text-color-secondary d-flex flex-nowrap align-items-center fw-normal">
                                                                                <span class="partially-paid rounded-circle d-block me-2"></span>Complete
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <!--end::Table content-->
                                                    <div class="status-bar rounded mb-6 d-flex flex-row overflow-hidden">
                                                        <div class="active-status-bar" style="width:50%"></div>
                                                        <div class="inactive-status-bar" style="width:45%"></div>
                                                        <div class="partially-paid-status-bar" style="width:5%"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <table class="table table-row-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h6 class="text-color fw-semibold text-nowrap">Video Conference 60 minutes</h6>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="text-color fw-semibold text-nowrap">28 Jul 2023 11:10 AM</h6>
                                                                    </td>
                                                ...
                                                <div class="card-header px-0 pt-5">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                                        ...
                                                        <div class="col-lg-3     col-3">
                                                            <h3 class="card-title align-items-start flex-column">
                                                                <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                                    <span class="ms-0">Stakeholder Reviews</span>
                                                                </span>
                                                            </h3>
                                                        </div>
                                                        <!--end::Title-->
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex align-items-center px-0">
                                                                            <!--begin::Avatar-->
                                                                            <div class="symbol symbol-50px me-2">
                                                                                <img alt="Logo" src="assets/media/avatars/300-1.jpg" class="rounded-circle user-picture">
                                                                            </div>
                                                                            <!--end::Avatar-->
                                                                            <!--begin::Username-->
                                                                            <div class="d-flex flex-column">
                                                                                <div class="text-color fw-semibold d-flex align-items-center fs-6">Prakash Singh
                                                                                </div>
                                                                            </div>
                                                                            <!--end::Username-->
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <h6 class="fw-normal"> Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur.</h6>
                                                                    </td>
                                                                    <td>
                                                                        <h6 class="text-color-secondary fw-semibold my-4">20/06/2023</h6>
                                                                    </td>
                                                                    <td>
                                                                        <h6 class="text-color-secondary fw-semibold my-4">4/5</h6>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-row gap-4 align-items-center">
                                                                ...
                                                                <div class="">
                                                                    <h6 class="text-color fw-semibold me-2 text-nowrap">Effective Time Management</h6>
                                                                    <h6 class="text-color-secondary fs-7 fw-semibold d-flex align-items-center"><span class="me-2 flag-sm bg-danger rounded-circle"><i class="bi bi-flag-fill fs-7 text-white"></i></span> ABC Test Company RV</h6>
                            ...
                            <div class="tab-pane fade" id="Profile" role="tabpanel" aria-labelledby="Profile-tab" tabindex="0">
                                <div class="row gap-0">
                                    <div class="col-lg-8">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                            ...
                                            <div class="col-lg-2 col-2">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                        <span class="ms-0">Video Introduction</span>
                                                    </span>
                                                </h3>
                                            </div>
                                            <!--end::Title-->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mt-2">
                                                <div class="position-relative">
                                                    <img src="assets/media/other/profile-img.png" class="img-fluid rounded my-4">
                                                    <span>
                                                        <img src="assets/media/other/play-button.png" class="img-fluid intro-play-btn position-absolute">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mt-5">
                                                <div class="row">
                                                    <div class="col-lg-3 col-3">
                                                        <h3 class="card-title align-items-start flex-column">
                                                            <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                                <span class="text-color fw-bolder ms-0">About me</span>
                                                            </span>
                                                        </h3>
                                                    </div>
                                                    <!--end::Title-->
                                                    <div class="col-lg-9 col-9 my-auto">
                                                        <div class="custom-separator  mx-auto"></div>
                                                    </div>
                                                </div>
                                                <h3 class="text-color fw-bolder mt-5">Parul K Sharma</h3>
                                                <div class="p-2 py-0">
                                                    <div class="table-responsive">
                                                        <table class="table table-row-bordered table-row-gray-300 gy-4">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="fw-bolder text-color" fs-6>Designation:</td>
                                                                    <td class="text-color-secondary fw-semibold fs-6">Executive Coach</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-bolder text-co fs-6lor">Email:</td>
                                                                    <td class="text-color-secondary fw-semibold fs-6">parulksh@gmail.com</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-bolder text-color" fs-6>Phone Number:</td>
                                                                    <td class="text-color-secondary fw-semibold fs-6">+91 840562626262</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-bolder text-col fs-6or">Gender:</td>
                                                                    <td class="text-color-secondary fw-semibold fs-6">Female</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-bolder text-color fs-6">Location:</td>
                                                                    <td class="text-color-secondary fw-semibold fs-6">Mumbai, Maharashtra, India</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                        ...
                                        <div class="bio mt-2">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">My Bio</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div>
                                                <p class="text-color-secondary fw-semibold fs-6">No information yet!</p>
                                            </div>
                                        </div>

                                        <div class="active mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                <!--begin::Title-->
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Active Projects Capacity</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div>
                                                <p class="text-color-secondary fw-semibold fs-6">5 Projects</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="active mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Experience</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                                ...
                                                <div class="card">
                                                    <div class="row p-5">
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-semibold me-2">5 Years</h6>
                                                            <h6 class="text-color-secondary fs-7 fw-semibold d-flex align-items-center">Experience</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-semibold me-2">52</h6>
                                                            <h6 class="text-color-secondary fs-7 fw-semibold d-flex align-items-center">Completed engagements</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-semibold me-2">108</h6>
                                                            <h6 class="text-color-secondary fs-7 fw-semibold d-flex align-items-center"> Hours Coached</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="education mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Education</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                                ...
                                                <div class="card p-5">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-5">
                                                            <h6 class="text-color fw-bolder me-2">Phd., Management</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-semibold me-2">Oxford University</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-3">
                                                            <h6 class="text-color fw-semibold me-2">2019</h6>
                                                        </div>
                                                    </div>
                                                    <div class="separator my-5"></div>
                                                    <div class="row">
                                                        <div class="col-lg-4 col-5">
                                                            <h6 class="text-color fw-bolder me-2">MBA, Business Management</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-semibold me-2">Delhi University</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-3">
                                                            <h6 class="text-color fw-semibold me-2">2015</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="experience mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Credentials</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-12">
                                                    <div class="card p-5">
                                                        <h6 class="border-bottom text-color-secondary fw-bolder pb-2">Credentials</h6>
                                                        <h6 class="text-color fw-bolder mt-4">The Leadership Circle</h6>
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <h6 class="text-color-secondary fw-semibold">Aug 2020- Does not expire</h6>
                                                            <h6 class="text-color-secondary fw-semibold">121232544</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-12 mtx-sm-5">
                                                    <div class="card p-5">
                                                        <h6 class="border-bottom text-color-secondary fw-bolder pb-2">Assessments</h6>
                                                        <h6 class="text-color fw-bolder mt-4">Benchmarks 360 Assesments</h6>
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <h6 class="text-color-secondary fw-semibold">Certified for 5 years</h6>
                                                            <h6 class="text-color-secondary fw-semibold"></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="education mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Work Experience</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div>
                                                <div class="card p-5">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-bolder me-2">CEO</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Willow Consultants</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Aug 2021 - Nov 2022</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Mumbai, India</h6>
                                                        </div>
                                                    </div>
                                                    <div class="separator my-5"></div>
                                                    <div class="row">
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-bolder me-2">CFO</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Willow Consultants</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Aug 2019 - Aug 2021</h6>
                                                        </div>
                                                        <div class="col-lg-3 col-3">
                                                            <h6 class="text-color fw-semibold me-2">Mumbai, India</h6>
                                                        </div>
                                        ...
                                        <div class="education mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Modalities</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div>
                                                <div class="card p-5">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-bolder me-2">Phone Conference</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-bolder me-2">Video Conference</h6>
                                                        </div>
                                                        <div class="col-lg-4 col-4">
                                                            <h6 class="text-color fw-bolder me-2">In person </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="education mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Feedback</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                                ...
                                                <div class="p-5">
                                                    <div class="row">
                                                        <div class="col-lg-2 col-12">
                                                            <div class="text-color fs-6 fw-normal text-center">4.32 out 5</div>
                                                            <div id="rating" class="d-flex flex-wrap align-items-end">
                                                                <span class="fw-6 fw-semibold text-color me-3">5.0</span>
                                                            ...
                                                            <div id="rating" class="d-flex flex-wrap align-items-end">
                                                                <span class="fw-6 fw-semibold text-color me-3">2.1</span>
                                                                <span class="material-symbols-outlined star">
                                                                    star
                                                                </span>
                                                                <span class="material-symbols-outlined star">
                                                        ...
                                                        <div class="col-lg-5 col-6">
                                                            <div class="card p-2 p-md-4">
                                                                <div class="d-flex justify-content-between flex-wrap align-items-center">
                                                                    ...
                                                                    <h6 class="text-color-secondary">28 Jul 2023</h6>
                                                                </div>
                                                                <div class="number fs-6 text-color my-4 fw-bold">
                                                                    4/5
                                                                </div>
                                                                <div class="message text-color-secondary fs-6">
                                                                    In neque viverra amet morbi et. Lorem ipsum dolor sit amet consectetur. In neque viverra amet morbi et.
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5 col-6">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="coaching-type">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Coaching Type</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-wrap gap-3 my-4">
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Electronics</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Manufacturing</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Supply Chain</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Marketing</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Compliance</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Electronics</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Manufacturing</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Supply Chain</span>
                                                <span class="badge select-bg fw-normal fs-6 select-rounded px-2 p-1">Marketing</span>
                                        ...
                                        <div class="coaching-type mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                <!--begin::Title-->
                                                <div class="col-lg-4 col-4">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Target Audience</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                        ...
                                        <div class="coaching-type mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                ...
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Industries</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
                                        ...
                                        <div class="specialities mt-5">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100 mt-5">
                                                <!--begin::Title-->
                                                <div class="col-lg-3 col-3">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark d-flex flex-nowrap align-items-center">
                                                            <span class="ms-0 my-3">Specialities</span>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <!--end::Title-->
