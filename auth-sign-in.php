...
<div class="login-container">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide color-1">
                    ...
                    <div class="slide-content">
                        <h2 class="text-white">Empower</h2>
                        <p class="text-white">Unlock Your Coaching Potential with CoachOptima</p>
                    </div>
                </div>
                <div class="swiper-slide color-1">
                    <div class="slide-image">
    ...
    <div class="login-form">
        <div class="login-form-inner text-center">
            <div class="logo"><img src="assets/media/logos/coachoptimalogo.png" class="img-fluid" alt="" srcset=""></div>

            <div class="login-form-group mt-28px">
            ...
            <a href="index.html" class="rounded-button login-cta">Login</a>

            <div class="register-div">Not registered yet?
                <a href="#" class="link create-account" -link>Create an
                    account ?
                </a>
            </div>
