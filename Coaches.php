                    ...
                    <div class="row gx-5 gx-xl-10">
                        ...
                        <div class="col-md-12 col-12 mb-5 mb-xl-10 ">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="col-lg-3 col-12 total-client card-border-start px-3 card-border-sm-bottom">
                                    ...
                                    <p class="text-color-secondary">A coach with atleast one active project with atleast one scheduled session.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-12 total-client card-border-start px-3 card-border-sm-bottom mtx-sm-5">
                                    ...
                                    <p class="text-color-secondary">A coach with no active projects.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-12 total-client card-border-start px-3 card-border-sm-bottom mtx-sm-5">
                                    ...
                                    <p class="text-color-secondary">A coach with an active project with no scheduled or active session.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-12 total-client card-border-start px-3 card-border-sm-bottom mtx-sm-5">
                                    ...
                                    <p class="text-color-secondary">A coach with a pending project or a pending session.</p>
                                </div>
                            </div>
                            <!--end::Chart widget 8-->
                        </div>
                        ...
                        <div>
                            ...
                            <div class="status-bar rounded mb-6 d-flex flex-row overflow-hidden mb-5">
                                ...
                                <div class="no-invoice-invoice-bar" style="width:20%"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
                            ...
                            <div class="card card-bg shadow-0 border-0 card-flush h-xl-100">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                        ...
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link client-nav text-color active" id="All-Coaches-tab" data-bs-toggle="pill" data-bs-target="#All-coaches" type="button" role="tab" aria-controls="All-coaches" aria-selected="true">All Coaches</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                ...
                                <div class="card-body px-4 rounded overflow-hidden p-2">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="All-coaches" role="tabpanel" aria-labelledby="All-coaches-tab" tabindex="0">
                                            <div>
                                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex flex-nowrap mtx-sm-5">
                                                        ...
                                                        <a href="#" class="btn btn-padding p-2 px-2 h-100 btn-orange hover-scale text-white">
                                                            Add Coaches <span><i class="bi bi-plus-lg text-white fs-6"></i></span>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="row gap-5 gx-0 my-5">
                                                    <div class="col px-0">
                                                        <select class="form-select select-bg select-rounded form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                                            <option></option>
                                                            <option value="1" selected>Filter by Loaction</option>
                                                    ...
                                                    <div class="col px-0">
                                                        <select class="form-select select-bg select-rounded form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                                            <option></option>
                                                            <option value="1" selected>Select Experience</option>
                                                    ...
                                                    <div class="col px-0">
                                                        <select class="form-select select-bg select-rounded form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                                            <option></option>
                                                            <option value="1" selected>Select Credentials</option>
                                                            <option value="2">The Leadership Circle</option>
                                                            <option value="3">One on One</option>
                                                        </select>
                                                    </div>
                                                    <div class="col px-0">
                                                        ...
                                                        <table class="table table-row-bordered">
                                                            <thead>
                                                                <tr class="fw-bolder fs-5 text-gray-800">
                                                                    ...
                                                                    <th>Experience</th>
                                                                    <th>Credentials</th>
                                                                    <th class="text-nowrap">Domain Industries</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                        ...
                                                                        <div class="px-0">
                                                                            <div class="menu-content d-flex align-items-center px-0">
                                                                                ...
                                                                                <div class="d-flex flex-column">
                                                                                    <div class="text-color fw-bold d-flex align-items-center fs-5"><a href="coach-profile.php" class="text-decoration-none text-color text-hover-primary">Robert Fox</a></div>
                                                                    ...
                                                                    <td>
                                                                        <h6 class="my-4 fw-semibold text-color-secondary text-nowrap">Mumbai, MH</h6>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="my-4 fw-semibold text-color-secondary">Female</h6>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="my-4 fw-semibold text-color-secondary">10 Years</h6>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="my-4 fw-semibold text-color-secondary text-nowrap">The Leadership Circle</h6>
                                                                    </td>

                                                                    <td>
                                                                        <div class="d-flex flex-wrap gap-3 my-4">
                                                                            <span class="badge bg-white fs-6 select-rounded px-2 p-1">Electronics</span>
                                                                            <span class="badge bg-white fs-6 select-rounded px-2 p-1">Manufacturing</span>
                                                                            <span class="badge bg-white fs-6 select-rounded px-2 p-1">Supply Chain</span>
                                                                            <span class="badge bg-white fs-6 select-rounded px-2 p-1">Marketing</span>
                                                                            <span class="badge bg-white fs-6 select-rounded px-2 p-1">Compliance</span>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="px-0">
                                                                            <div class="menu-content d-flex align-items-center px-0">
                                                                                ...
                                                                                <div class="d-flex flex-column">
                                                                                    <div class="text-color fw-bold d-flex align-items-center fs-5"><a href="coach-profile.php" class="text-decoration-none text-color text-hover-primary">Robert Fox</a>
                                                                                    </div>
                                                                                    <a href="#" class="text-color-secondary fw-semibold fs-7">sid@google.com</a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <td>
                                                                        <h6 class="my-4 fw-semibold text-color-secondary">Male</h6>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <!-- <h6 class="my-4 fw-normal">In Person</h6> -->
                                                                        <h6 class="text-color-secondary my-4 d-flex flex-nowrap align-items-center">
                                                                            <span class="draft rounded-circle d-block bg-danger me-2"></span>Pending
                                                                        </h6>
                                                                    </td>
