                ...
                <div class="page-header p-0 p-lg-10">
                    <div class="row p-4 rounded">
                        <div class="col-lg-8 col-8">
                            <h4 class="fw-bold text-white mb-5">Client Profile</h4>
                            <div class="d-flex flex-row gap-4 align-items-center">
                                <img src="assets/media/other/IconC.png" width="60" class="img-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid mb-5">
                    ...
                    <div class="row gx-5 gx-xl-10 mb-5">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link client-nav text-color" id="Billing-tab" data-bs-toggle="pill" data-bs-target="#Billing" type="button" role="tab" aria-controls="Billing" aria-selected="false">Billing</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-pane fade show active" id="Overview" role="tabpanel" aria-labelledby="Overview-tab" tabindex="0">
                                <div class="row">
                                    ...
                                    <div class="row px-0 mt-5">
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                                ...
                                                <!--end::Title-->
                                                <div class="col-lg-7 d-sm-none d-md-block">
                                                    <div class="custom-separator my-auto mx-auto"></div>
                                                </div>
                                                <!--begin::Toolbar-->
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column text-nowrap">
                                                                            ...
                                                                            <p class="fw-normal text-color-secondary">32<span class="badge ms-3 badge-secondary">4 Active this month</span></p>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <div class="row mt-5">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-lg-2">
                                                <h4 class="text-color fw-bold">Timeline / Journey</h4>
                                            </div>
                                            <div class="col-lg-10 my-auto">
                                                <div class="custom-separator my-auto mx-auto"></div>
                                            </div>
                                        </div>
                                        <div class="bg-white pb-10 mt-5 rounded">
                                            <div class="d-flex justify-content-between mt-4">
                                                <p class="text-color fs-6 fw-bold">Project Created by:
                                                    <span class="fs-6 text-color-secondary ms-2"><img alt="Logo" src="assets/media/avatars/300-1.jpg" class="rounded-circle user-picture-24 me-2 ">Prakhar</span>
                                                    <span class="badge ms-1 badge-secondary text-color-secondary">User</span>
                                                </p>
                                                <p class="badge ms-3 badge-secondary fs-6 text-color-secondary">8 Jul 2023 11:54 AM</p>
                                            </div>
                                            <div class="card">
                                                <div class="d-flex flex-wrap flex-column flex-lg-row p-5">
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Start Date: </h6>
                                                        <h6 class="fw-normal text-color-secondary">12 Jul 2023</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Project Title:</h6>
                                                        <h6 class="fw-normal text-color-secondary">Effective Time Management</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Service:</h6>
                                                        <h6 class="fw-normal text-color-secondary">Business Coaching</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Current Status:</h6>
                                                        <h6 class="fw-normal text-color-secondary">Inactive</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Coach Added: </h6>
                                                        <h6 class="fw-normal text-color-secondary"><span class="fs-6 text-color-secondary ms-2"><img alt="Logo" src="assets/media/avatars/300-1.jpg" class="rounded-circle user-picture-24 me-2">Prakhar</span></h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between mt-4">
                                                <p class="text-color fs-6 fw-bold">Sessions Added by::
                                                    <span class="fs-6 text-color-secondary ms-2"><img alt="Logo" src="assets/media/avatars/300-1.jpg" class="rounded-circle user-picture-24 me-2 ">Parul K Sharma</span>
                                                    <span class="badge ms-1 badge-secondary text-color-secondary">Coach</span>
                                                </p>
                                                <p class="badge ms-3 badge-secondary fs-6 text-color-secondary">8 Jul 2023 14:32 PM</p>
                                            </div>
                                            <div class="card">
                                                <div class="d-flex flex-wrap flex-column flex-lg-row p-5">
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Sessions Added:</h6>
                                                        <h6 class="fw-normal text-color-secondary">5</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Modality:</h6>
                                                        <h6 class="fw-normal text-color-secondary">Video Conference</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Time Period:</h6>
                                                        <h6 class="fw-normal text-color-secondary">60 Minutes</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Start Date:</h6>
                                                        <h6 class="fw-normal text-color-secondary">Not scheduled yet!</h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Coach:</h6>
                                                        <h6 class="fw-normal text-color-secondary"><span class="fs-6 text-color-secondary ms-2"><img alt="Logo" src="assets/media/avatars/300-1.jpg" class="rounded-circle user-picture-24 me-2">Prakhar</span></h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="fw-bold text-color">Current Status:</h6>
                                                        <h6 class="fw-normal text-color-secondary d-flex justify-content-start align-items-center">
                                                        ...
                                                        <td>
                                                            <div class="px-0">
                                                                <div class="menu-content d-flex align-items-center px-0">
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <div class="fw-semibold text-color-secondary text-nowrap d-flex align-items-center fs-5">Robert
                                                                            Fox
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-row gap-4 align-items-center">
                                                                ...
                                                                <div class="">
                                                                    <h6 class="text-color fw-semibold mb-0 my-4">Effective Time Management</h6>
                                            ...
                                            <table class="table table-row-bordered">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800">
                                                        ...
                                                        <th class="text-nowrap">Sessions Progress </th>
                                                        <th>Last Session</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="my-4 fw-semibold text-color-secondary text-nowrap">Effective Time Management <span class="w-16px h-16px bg-danger rounded-circle p-1 px-2"><i class="bi bi-flag-fill fs-6 text-white"></i></span></h6>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-start flex-column mt-3">
                                                                ...
                                                                <div class="h-5px mx-0 w-100 bg-light mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                            ...
                                            <div class="col-lg-2 col-3">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bolder text-dark d-flex flex-nowrap align-items-center">
                                                        <span class="ms-0">Billing Details</span>
                                                    </span>
                                                </h3>
                                            </div>
                                            <!--end::Title-->
                                            ...
                                            <div class="col-lg-2 col-4">
                                                <a href="#" class="btn btn-padding p-2 px-2 h-100 btn-orange hover-scale text-white">
                                                    Update <span><i class="bi bi-arrow-up text-white fs-6"></i></span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card mt-4">
                                            <div class="bg-white px-4 rounded overflow-hidden p-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 company">
                                                        <h6 class="text-color fw-bold fs-6">Company</h6>
                                                        <h6 class="text-color-secondary fw-normal fs-5">ABC Test Company</h6>
                                                    </div>
                                                    <div class="col-lg-6 company">
                                                        <h6 class="text-color fw-bold fs-6">Company Email</h6>
                                                        <h6 class="text-color-secondary fw-normal fs-5">info@abccompany.com</h6>
                                                    </div>
                                                </div>
                                                <div class="company mt-5">
                                                    <h6 class="text-color fw-bold fs-6">Billed to</h6>
                                                    <h6 class="text-color-secondary fw-normal fs-5">Sid Bhasin (sidbhasin02@gmail.com)</h6>
                                                </div>
                                                <div class="company mt-5">
                                                    <h6 class="text-color fw-bold fs-6">Address</h6>
                                                    <h6 class="text-color-secondary fw-normal fs-5">S-403, sanskriti enclavee, Pune, Maharashtra, India, 411026</h6>
                                                </div>
                                                <div class="row mt-5">
                                                    <div class="col-lg-6  company">
                                                        <h6 class="text-color fw-bold fs-6">Currency</h6>
                                                        <h6 class="text-color-secondary fw-normal fs-5">₹ - INR</h6>
                                                    </div>
                                                    <div class="col-lg-6  company">
                                                        <h6 class="text-color fw-bold fs-6">GST / Tax / VAT</h6>
                                                        <h6 class="text-color-secondary fw-normal fs-5">18%</h6>
                                                    </div>
                                                </div>
                                                <!--end::Tab content-->
                                            </div>
                                                        ...
                                                        <table class="table table-row-bordered mb-0">
                                                            <thead>
                                                                <tr class="fw-bold fs-6 text-gray-800">
                                                                    ...
                                                                    <th>Amount</th>
                                                                    <th>Status</th>
                                                                    <th class="text-nowrap">Invoice Sent Date</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h6 class="fw-bold text-color my-6 text-nowrap">6B1E73DA–0017</h6>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="fw-bold text-color my-6 text-nowrap">₹ 118,000</h6>
                                                                    </td>

                                                                    <td>
                                                                        <span class="badge badge-light-success my-6">Invoice sent</span>
                                                                    </td>

                                                                    <td>
                                                                        <h6 class="fw-bold text-color my-6">30/04/2023</h6>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span class="badge badge-light-warning my-6">Draft Invoice</span>
                                                                    </td>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-row-bordered mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h6 aria-colspan="4" class="fw-bold text-color text-center my-6">No Data Available</h6>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
